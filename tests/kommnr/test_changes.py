...
def test_date_parsing_and_default(
    ...
    if errors:
        with pytest.raises(ValueError):
            get_kommnr_changes(from_date=input_from_date, to_date=input_to_date, target_date=input_target_date)
        mock_get_klass_change_mapping.assert_not_called()
        return

    _changes, _splits = get_kommnr_changes(from_date=input_from_date, to_date=input_to_date, target_date=input_target_date)
