...
from ssb_befolkning_fagfunksjoner.date_utils.periods import get_standardised_period_label
...
def test_get_standardised_period_label_valid(inputs, expected):
...
def test_get_standardised_period_label_invalid(inputs, message_regex):
